...
| Gestion web completa de Storage existente | Hecho | `/admin/storage` navega por categorias/subcategorias como Telegram, lista entradas directas como tarjetas con descripcion, metadatos y miniatura cuando hay imagen, abre un visor modal para recorrer todas las imagenes de la entrada, mantiene busqueda global, permite editar descripcion/categoria/tags/estado, mover categorias, archivar categorias y eliminar logicamente entradas; no permite crear desde web |
