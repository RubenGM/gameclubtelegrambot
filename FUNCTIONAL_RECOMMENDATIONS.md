...
| F-004 | Exposar `Calendari` o crear `Avui al club` | fet | alta | Activitats | `Calendari` es visible al menu principal al costat d'`Activitats` per a usuaris aprovats i administradors. |
