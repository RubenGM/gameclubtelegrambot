...
| F-009 | Recordatoris de compres conjuntes | fet | mitjana | Compres conjuntes | Worker intern avisa per privat 24h abans del deadline de confirmacio als participants pendents (`interested`), amb registre persistent per evitar duplicats. |
