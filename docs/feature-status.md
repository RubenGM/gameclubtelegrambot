...
- Asistencia como jugador o espectador/acompañante y gestión de acompañantes:
  - En actividades abiertas, un usuario puede apuntarse en un clic como Jugador (`🎮 Apuntarme a jugar`, consume 1 plaza) o como Espectador / Acompañante (`👀 Apuntarme de espectador`, consume 0 plazas).
  ...
  - La visualización de detalle distingue la lista de `Jugadores` (`Assistents`) y `Acompañantes / Espectadores`, mostrando la ocupación de plazas computando únicamente a los jugadores.
  - Los asistentes activos (jugadores o espectadores) disponen del botón `👥 Acompañantes (+X)` para gestionar cuántos acompañantes adicionales traen consigo (+1, -1, 0 acompañantes); los acompañantes no consumen plazas de juego y se reflejan como sufijo `(+X)` junto al nombre del asistente en la ficha de la actividad.
  - Los asistentes activos pueden cambiar de rol en cualquier momento desde el detalle (`👀 Pasar a espectador` / `🎮 Pasar a jugar`, sujeto a disponibilidad de plazas libres).
  - Al pulsar `Salir` (`Desapuntarme`), la baja libera tanto la plaza como los acompañantes asociados del usuario.
