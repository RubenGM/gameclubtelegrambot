...
- Listado y snapshots de grupo con enlace `Ver detalles` solo cuando la actividad tiene mensaje extra guardado; en ese caso no imprimen la descripción larga en línea y el deep link reenvía el mensaje original al usuario.
