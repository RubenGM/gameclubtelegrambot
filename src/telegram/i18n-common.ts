export const commonTexts = {
  ca: {
    ...
    welcomeTemplatesDeleteButton: 'Eliminar benvinguda',
    welcomeTemplatesDeleteConfirmButton: 'Confirmar eliminació de benvinguda',
    ...
    catalogWebAdminOffer: "L'enllaç obre el mode d'administració web del catàleg. És personal, es pot reutilitzar i caduca en 1 hora.",
    catalogWebAdminError: "No s'ha pogut generar l'accés web.",
  ...
  es: {
    ...
    welcomeTemplatesToggleEnabledButton: 'Activar/desactivar',
    welcomeTemplatesDeleteButton: 'Eliminar bienvenida',
    welcomeTemplatesDeleteConfirmButton: 'Confirmar eliminación de bienvenida',
    ...
    catalogWebAdminOffer: 'El enlace abre el modo de administración web del catálogo. Es personal, se puede reutilizar y caduca en 1 hora.',
    catalogWebAdminError: 'No se ha podido generar el acceso web.',
  ...
  en: {
    ...
    welcomeTemplatesDeleteButton: 'Delete welcome message',
    welcomeTemplatesDeleteConfirmButton: 'Confirm welcome-message deletion',
    ...
    catalogWebAdminOffer: 'The link opens the web catalog administration mode. It is personal, reusable, and expires after 1 hour.',
    catalogWebAdminError: 'The web access link could not be generated.',
...
export const actionMenuTexts = {
  ca: {
    ...
    imageGenerationAdmin: 'Imatges IA',
  ...
  es: {
    ...
    imageGenerationAdmin: 'Imágenes IA',
  ...
  en: {
    ...
    imageGenerationAdmin: 'AI images',
    askBot: 'Ask the bot',
    admin: 'Admin',
    tables: 'Tables',
    equipment: 'Equipment',
