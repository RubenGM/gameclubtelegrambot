...
test('createTelegramBoundary reports a connected bot when long polling starts', async () => {
  ...
  assert.deepEqual(events, [
    ...
    'register:callback:membership_user:detail:',
    ...
    'register:callback:news_group:toggle',
    'register:callback:news_group:refresh',
    'register:callback:news_group:subscribe:',
    'register:callback:news_group:unsubscribe:',
    ...
    'register:callback:catalog_loan:admin_dashboard',
    'register:callback:catalog_loan:admin_dashboard:',
    ...
    'register:callback:catalog_admin:browse_letters:',
    ...
    'register:callback:catalog_admin:owner_self:',
    'register:callback:catalog_admin:owner_page:',
    'register:callback:catalog_admin:owner_select:',
    'register:callback:catalog_admin:owner_clear:',
    ...
    'register:callback:storage:category_page:',
    'register:callback:storage:category_goto:',
