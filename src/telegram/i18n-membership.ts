export const membershipTexts = {
  ca: {
    ...
    blocked: "El teu accés està blocat. Contacta amb l'administració del club si necessites revisió.",
    alreadyPending: "La teva sol·licitud ja està pendent de revisió per part d'un administrador.",
    created: "Hem registrat la teva sol·licitud d'accés. Un administrador la revisarà al més aviat possible.",
    missing: "No s'ha trobat cap sol·licitud per a aquest usuari.",
    applicantApproved: 'La teva sol·licitud ha estat aprovada. Ja pots utilitzar les funcionalitats del club.',
    adminApproved: 'Usuari aprovat correctament.',
    applicantRejected: "La teva sol·licitud d'accés ha estat rebutjada. Si creus que és un error, contacta amb el club.",
    adminRejected: 'Sol·licitud rebutjada i usuari blocat.',
    requestNotificationsEnabled: "Ara rebràs avisos privats de noves sol·licituds d'accés.",
    requestNotificationsDisabled: "Ja no rebràs avisos privats de noves sol·licituds d'accés.",
    requestNotificationsAlreadyEnabled: "Ja tenies activats els avisos de noves sol·licituds d'accés.",
    requestNotificationsAlreadyDisabled: "Ja tenies desactivats els avisos de noves sol·licituds d'accés.",
    newRequestNotification: "Nova sol·licitud d'accés de {label}.",
    previousRevocationNotification: 'Atenció: aquest usuari ja va ser expulsat el {date}. Motiu: {reason}',
  ...
  es: {
    ...
    blocked: 'Tu acceso está bloqueado. Contacta con la administración del club si necesitas revisión.',
    alreadyPending: 'Tu solicitud ya está pendiente de revisión por parte de un administrador.',
    created: 'Hemos registrado tu solicitud de acceso. Un administrador la revisará lo antes posible.',
    ...
    previousRevocationNotification: 'Atención: este usuario ya fue expulsado el {date}. Motivo: {reason}',
