...
export const runtimeConfigFieldSpecs: RuntimeConfigFieldSpec[] = [
  ...
  },
  {
    ...
    optional: true,
    description: 'Model passed to OpenCode for command interpretation.',
  ...
  },
  {
    ...
    optional: true,
    description: 'Reasoning effort preference recorded for the LLM command service.',
    example: 'low',
  },
  {
    section: 'LLM Commands',
    ...
    optional: true,
    description: 'Maximum time to wait for OpenCode to return an interpretation.',
    min: 1000,
    max: 120000,
  },
  {
